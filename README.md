...
## GENERAL NOTES
* Provide examples using Prophecy (i.e. compared to Mockery, mockBuilder, or anon class)
* Provide example testing a file upload

## ERRATA
* Redo the links for PHP Unit 7
* Look for "textXXX()"
* PHP Unit version 6 allows for "_" style namespaces whereas PHP Unit 7 has switched to "\\" style
* Make sure the API simulator is working for PHP 7.2
